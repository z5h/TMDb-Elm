...
var author$project$Route$routeParser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			author$project$Route$Movie,
			A2(
				elm$url$Url$Parser$slash,
				elm$url$Url$Parser$s('movie'),
			...
			if (!_n0.b.b) {
				...
				return A2(
					...
					A2(
						...
						_Utils_update(
							url,
							{fragment: elm$core$Maybe$Nothing, path: path})));
			} else {
				if (!_n0.b.b.b) {
					var path = _n0.a;
					var _n1 = _n0.b;
...
var author$project$Main$init = F3(
	function (flags, url, key) {
		var model = {apiKey: flags.apiKey, errors: _List_Nil, height: flags.height, key: key, moviePageModel: elm$core$Maybe$Nothing, route: author$project$Route$Home, url: url, width: flags.width};
		var _n0 = A2(
			author$project$Main$newRoute,
			model,
			author$project$Route$fromUrl(url));
		var result = _n0.a;
		var cmd = _n0.b;
		return _Utils_Tuple2(result, cmd);
	});
var author$project$Main$MoviePageMsg = function (a) {
	return {$: 'MoviePageMsg', a: a};
};
...
var author$project$MoviePage$update = F2(
	function (msg, model) {
...
var z5h$component_result$ComponentResult$mapModel = F2(
	function (f, result) {
		switch (result.$) {
			case 'ModelAndCmd':
				var model = result.a;
				var cmd = result.b;
				return A2(
					z5h$component_result$ComponentResult$ModelAndCmd,
					f(model),
					cmd);
			case 'ModelAndExternal':
				var model = result.a;
				...
				var cmd = result.c;
				return A3(
					z5h$component_result$ComponentResult$ModelAndExternal,
					f(model),
					externalMsg,
					cmd);
			default:
...
var z5h$component_result$ComponentResult$mapMsg = F2(
	function (f, result) {
		switch (result.$) {
			case 'ModelAndCmd':
				var model = result.a;
...
var z5h$component_result$ComponentResult$resolve = function (result) {
	switch (result.$) {
		case 'ModelAndCmd':
			var model = result.a;
			var cmd = result.b;
		...
		switch (msg.$) {
			...
			case 'OnUrlChange':
				...
				return A2(
					...
					route);
			default:
				var moviePageMsg = msg.a;
				var _n2 = model.moviePageModel;
				if (_n2.$ === 'Just') {
					var moviePageModel = _n2.a;
					return z5h$component_result$ComponentResult$resolve(
						A2(
							z5h$component_result$ComponentResult$mapMsg,
							author$project$Main$MoviePageMsg,
							A2(
								z5h$component_result$ComponentResult$mapModel,
								function (updatedMoviePageModel) {
									return _Utils_update(
										model,
										{
											moviePageModel: elm$core$Maybe$Just(updatedMoviePageModel)
										});
								},
								A2(
									z5h$component_result$ComponentResult$applyExternalMsg,
									F2(
										function (externalMsg, result) {
											return result;
										}),
									A2(author$project$MoviePage$update, moviePageMsg, moviePageModel)))));
				} else {
					return z5h$component_result$ComponentResult$resolve(
...
var author$project$Ux$colorDarkBackground = A3(mdgriffith$elm_ui$Element$rgb255, 33, 33, 33);
var mdgriffith$elm_ui$Element$rgb = F3(
	function (r, g, b) {
		return A4(mdgriffith$elm_ui$Internal$Model$Rgba, r, g, b, 1);
	});
var author$project$Ux$colorWhite = A3(mdgriffith$elm_ui$Element$rgb, 1.0, 1.0, 1.0);
var author$project$Ux$spaceMedium = 10;
...
var author$project$Main$menu = function (title) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$padding(author$project$Ux$spaceMedium),
				mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
				mdgriffith$elm_ui$Element$Background$color(author$project$Ux$colorDarkBackground),
				mdgriffith$elm_ui$Element$Font$color(author$project$Ux$colorWhite)
			]),
		mdgriffith$elm_ui$Element$text(title));
};
var author$project$Ux$fontSizeDefault = 20;
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$menu('Movies')),
						mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$fill),
						mdgriffith$elm_ui$Element$Font$size(author$project$Ux$fontSizeDefault)
					]),
					...
					return A2(
						...
						function (apiKey) {
							return elm$json$Json$Decode$succeed(
								{apiKey: apiKey, height: height, width: width});
						},
